...
/parent-stats --window 7d --format tsv --fields core --limit 0
```
...
claude -p '/parent-stats --window 7d --format json --fields core --limit 0'
```
...
python3 scripts/parent_stats.py --window 7d --format tsv --fields core --limit 0
```
